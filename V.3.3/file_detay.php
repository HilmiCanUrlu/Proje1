                            ...
                            <div class="col-md-6">
                                ...
                                <div class="section-card">
                                    <div class="section-title">
                                        ...
                                        Parsel Bilgileri
                                        <button class="btn btn-secondary btn-sm ms-auto">Düzenle</button>
                                    </div>
                                    <div class="row g-2">
                                        <div class="col-md-12">
                                            <div class="mb-2">
                                                ...
                                                <div class="d-flex align-items-center">
                                                    <span id="tapuMaliki"><?php echo htmlspecialchars($dosya['musteri_adi']); ?></span>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                        ...
                                        <div class="col-md-4">
                                            <div class="mb-2">
                                                <label class="small text-muted">Alanı</label>
                                                <div class="d-flex align-items-center">
                                                    <span id="alani"><?php echo htmlspecialchars($dosya['alan'] ?? '0,00'); ?></span>
                            ...
                            <div class="col-md-6">
                                <div class="section-card">
                                    <div class="section-title">
                                        ...
                                        Yetkili Personel
                                        <button class="btn btn-secondary btn-sm ms-auto">Personel Ekle</button>
                                    </div>
