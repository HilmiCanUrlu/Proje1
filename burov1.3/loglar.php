    ...
    if ($_FILES['logo']['error'] == 0) {
        ...
        if (in_array($fileType, $allowedTypes)) {
            ...
            if (move_uploaded_file($_FILES['logo']['tmp_name'], $targetFilePath)) {
                $_SESSION['success_message'] = "Logo başarıyla yüklendi.";
            } else {
            ...
            echo '<script>
                Swal.fire({
                    icon: "error",
                    title: "Hata",
                    text: "Geçersiz dosya formatı. Lütfen JPG, JPEG, PNG veya GIF formatında bir dosya yükleyin.",
        ...
        echo '<script>
            Swal.fire({
                icon: "error",
                title: "Hata",
                text: "Dosya yüklenmedi veya bir hata oluştu.",
                showConfirmButton: false,
                timer: 1500
            });
        </script>';
