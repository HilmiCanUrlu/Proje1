...
--
-- Anamakine: 127.0.0.1
-- Üretim Zamanı: 14 May 2025, 18:50:30
...
INSERT INTO `dosyalar` (`dosya_id`, `izin_id`, `personel_id`, `musteri_id`, `olusturma_tarihi`, `islem_turu`, `dosya_turu`, `il`, `ilce`, `mahalle`, `ada`, `parsel`, `dosya_durumu`, `durum`) VALUES
(1, NULL, 1, NULL, '2025-03-02 13:04:21', 'İfraz Dosyası', 'SHKM Dosyaları', 'BURDUR', 'GÖLHİSAR', 'kyk', '1', '129', 'Hazırlandı', 'aktif'),
(2, NULL, 1, NULL, '2025-03-02 13:19:40', 'Yola Terk Dosyası', 'Takım Proje', 'BURDUR', 'GÖLHİSAR', 'kyk', '88', '200', 'Hazırlandı', 'aktif'),
(3, 4, 2, 4, '2025-03-02 14:40:31', 'Röperli Kroki', 'SHKM Dosyaları', 'ADANA', 'Akdeniz', 'kyk', '88', '129', 'Hazırlandı', 'aktif'),
(4, NULL, 2, 6, '2025-04-20 21:53:57', 'Röperli Kroki', 'LİHKAB', 'İZMİR', 'BORNOVA', 'küçükpark', '336', '36', 'Hazırlandı', 'aktif');

-- --------------------------------------------------------

--
-- Tablo için tablo yapısı `d_islem`
--

CREATE TABLE `d_islem` (
  `id` int(11) NOT NULL,
  `islem_turu` varchar(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Tablo döküm verisi `d_islem`
--

INSERT INTO `d_islem` (`id`, `islem_turu`) VALUES
(1, 'İfraz Dosyası'),
(2, 'Tus Dosyası'),
(3, 'Röperli Kroki'),
(4, 'Bağımsız Bölüm Planı'),
(5, 'Sınırlandırma Haritası'),
(6, 'Zemin Tespit Tutanağı'),
(7, 'Yapı Denetim Fenni Mesul'),
(8, 'Kamulaştırma Haritası'),
(9, 'Çalışma Dosyası'),
(10, 'Diğer Dosyalar'),
(11, '18. Madde Uygulaması'),
(12, 'Plankote'),
(13, 'Halihazır Harita'),
(14, 'Kat İrtifakı - Kat Mülkiyeti'),
(15, 'Yola Terk Dosyası'),
(16, 'Yoldan İhdas Dosyası'),
(17, 'Numarataj'),
(18, 'Yer Tespiti'),
(19, 'Yapı Aplikasyon Projesi'),
(20, '1/25000 Harita'),
(21, 'Rıza-i Taksim'),
(22, 'Ölçü Krokisi'),
(23, 'Vaziyet Planı'),
...
(29, 1, 'LOGIN', 'Kullanıcı girişi yapıldı: admin', '::1', '2025-04-21 07:14:30'),
(30, 2, 'LOGIN', 'Kullanıcı girişi yapıldı: ali', '::1', '2025-04-21 07:14:42'),
(31, 1, 'LOGIN', 'Kullanıcı girişi yapıldı: admin', '::1', '2025-04-21 07:17:05');
...
--
-- Tablo için AUTO_INCREMENT değeri `d_islem`
--
ALTER TABLE `d_islem`
