    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-2 sidebar py-3">
                <h4 class="mb-4 ps-3">Dosya Yönetimi</h4>
                <nav class="nav flex-column">
                    ...
                    <a class="nav-link active" href="yeni_dosya.php"><i class="bi bi-file-plus me-2"></i>Yeni Dosya Ekle</a>
        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <iframe src="yeni_musteri.php" style="width: 100%; height: 80vh; border: none;"></iframe>
                </div>
            </div>
        </div>
    </div>
