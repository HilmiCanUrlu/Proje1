...
// Hata raporlamayı ayarla - tüm hataları yakala ama gösterme
error_reporting(E_ALL);
ini_set('display_errors', 0);

// PHP error handler to log errors but not display them
...
function exceptionHandler($exception) {
    ...
    echo json_encode([
        'success' => false,
        'message' => 'Sistem hatası: ' . $exception->getMessage()
    ]);
...
// Make sure any output is flushed and the script ends cleanly
ob_end_flush();
exit();
?>